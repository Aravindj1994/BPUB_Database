...
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/course.csv' into table course fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/distributor.csv' into table distributor fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/student.csv' into table student fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/book.csv' into table book fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/seller.csv' into table seller fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/buyer.csv' into table buyer fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/payment.csv' into table payment fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/sale.csv' into table sale fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/book_copy.csv' into table book_copy fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/unretrieved_book.csv' into table unretrieved_book fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/retrieved_book.csv' into table retrieved_book fields terminated by ',' enclosed by '"' lines terminated by '\r\n';
load data  infile 'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/sold_book.csv' into table sold_book fields terminated by ',' enclosed by '"' lines terminated by '\r\n';